...
#define SL 7.6257 //distance from tracking center to middle of left wheel
#define SR 7.6257 //distance from tracking center to middle of right wheel
...
double DeltaL,DeltaR,DeltaB,currentL,currentR,PreviousL,PreviousR,DeltaTheta,X,Y,Theta,DeltaXSide,DeltaYSide,SideChord,OdomHeading,XPos,YPos;
/*---------------------------------------------------------------------------*/
/*                            Odometry Functions                             */
/*---------------------------------------------------------------------------*/
void TrackPOS() {
...
void usercontrol( void ) {
  while (1){
    ...
    TrackPOS();
    std::cout << LMotor.position(degrees) ; 
    std::cout << "    " << RMotor.position(degrees) << std::endl ;
